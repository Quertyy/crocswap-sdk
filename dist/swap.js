...
class CrocSwapPlan {
    ...
    userCmdCalldata(args = {}) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const TIP = 0;
            const surplusFlags = this.maskSurplusArgs(args);
            let abi = new utils_2.AbiCoder();
            return abi.encode(["address", "address", "uint256", "bool", "bool", "uint128", "uint16", "uint128", "uint128", "uint8"], [this.baseToken.tokenAddr, this.quoteToken.tokenAddr, (yield this.context).chain.poolIndex,
                this.sellBase, this.qtyInBase, yield this.qty, TIP,
                yield this.calcLimitPrice(), yield this.calcSlipQty(), surplusFlags]);
        });
    }
